...
public class DPOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(FoodPairingModel.CREATE_TABLE_FOOD_PAIRING);
        ...
        sqLiteDatabase.execSQL(WineTastingNoteModel.CREATE_TABLE_WINE_TASTING_NOTE);
        sqLiteDatabase.execSQL(WineFoodPairingModel.CREATE_TABLE_WINE_FOOD_PAIRING);
